-- Fix AI handoff exclusion: require "Telefone: https://wa.me/" (surname optional).
-- Previous regex required two words before Telefone:, so single-name lines slipped through.
